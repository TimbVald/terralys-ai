...
import { ArrowRight, Plane, ScanSearch } from "lucide-react"
    ...
    <section className="py-20 sm:py-24 lg:py-32">
      <div>
        ...
        >
          ...
          <h2 className="mx-auto max-w-4xl text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
            Analysez vos plantes{" "}
            <span className="text-primary dark:text-primary/90">en temps réel</span>
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:mt-8">
            Profitez de la puissance de l'IA pour détecter les maladies, parasites et carences nutritionnelles sur vos cultures. Téléchargez une image ou connectez un flux vidéo pour obtenir un diagnostic instantané et des recommandations personnalisées.
          </p>
          <div className="mt-8 sm:mt-10 flex justify-center">
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-col gap-2">
                <h3 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
                  Stay Updated on Detections
                </h3>
                <p className="text-lg text-muted-foreground">
                  Subscribe to receive updates on new features, model releases, and important detection events from our platform.
                </p>
              </div>
              <div className="w-full lg:w-auto max-w-md">
                ...
                <p className="mt-3 text-sm text-muted-foreground/80">
                  We respect your privacy. By subscribing you agree with our{" "}
